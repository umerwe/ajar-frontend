...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // CHANGED: Added 'hidden md:flex'. 
      // This hides the toast container on mobile/sm screens and shows it only on md+ screens.
      "fixed top-0 z-[100] hidden md:flex max-h-screen w-full flex-col-reverse gap-2 p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",
      className,
    )}
    {...props}
  />
  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "default" && "border border-aqua bg-white text-center md:text-left text-black md:bg-aqua md:text-white",
        variant === "destructive" && "border border-red-600 text-center bg-red-700 text-white",
        className,
      )}
      {...props}
    />
